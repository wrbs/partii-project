...
meaning most of the work is performed using C primitives and boxed floats. Much of the execution
...
code fields, requiring one more memory load to call a closure. In nearly all cases
this represented a slowdown from the initial compiler. The differing amounts of slowdown reflects
the variation in benchmark hot-path behaviour. A large drop reflects programs with
