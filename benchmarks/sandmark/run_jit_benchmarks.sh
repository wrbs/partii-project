...
BUILD_BENCH_TARGET=buildbench_both RUN_CONFIG_JSON=run_config_macro_bytecode.json make ocaml-versions/4.11.1+jit+compileonly.bench
BUILD_BENCH_TARGET=buildbench_both RUN_CONFIG_JSON=run_config_macro_bytecode.json make ocaml-versions/4.11.1+jit+disabled.bench
